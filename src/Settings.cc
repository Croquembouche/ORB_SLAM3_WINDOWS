...
#include <opencv2/calib3d.hpp>   // cv::stereoRectify, cv::CALIB_ZERO_DISPARITY, cv::initUndistortRectifyMap
#include <opencv2/imgproc.hpp>   // (some builds place remap/aux here; harmless to include)
